...
class CompatibilityLoopHandling:
    ...
    def __init__(self, assemblyDataProcessor: otaf.AssemblyDataProcessor):
        """Initialize the MatrixListsFromSystemData instance with system data.

        Args:
            assemblyDataProcessor (Dict[str, Dict[str, Dict[str, Any]]]): A dictionary containing system data.

        Attributes:
            assemblyDataProcessor (Dict[str, Dict[str, Dict[str, Any]]]): The provided system data.
